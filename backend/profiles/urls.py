...
from .views import (ProfileDetailView, ProfileUpdateView,
                    ...
                    ProfileFriendsListView, ProfilesListView)
...
urlpatterns = [
    ...
    path('all/', ProfilesListView.as_view(), name='profiles_list'),
    ...
    path('<str:sender_pk>/send_friend_request/<str:receiver_pk>/',
         FriendRequestCreateView.as_view(),
         name='send_friend_request'),

    # accept/refuse request
    path('<str:user_pk>/accept/<str:f_req_pk>/',
         FriendRequestAcceptView.as_view(),
         name='accept_friend_request'),
    path('<str:user_pk>/refuse/<str:f_req_pk>/',
         FriendRequestRefuseView.as_view(),
         name='refuse_friend_request'),

    # friends list
    path('<str:user_pk>/friends/',
         ProfileFriendsListView.as_view(),
         name='friends_list'),
    path('<str:user_pk>/remove/<str:friend_pk>/',
